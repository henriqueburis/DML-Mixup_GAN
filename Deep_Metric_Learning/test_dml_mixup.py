...
if(args.tsne_graph == "True"):
  ...
  plt.title(args.data_dir+'-'+str(args.max_epochs)+'ep-scale_mixup:'+str(args.scale_mixup)+'-alpha:'+str(args.alpha)+'-beta:'+str(args.beta)+'_tsne-XL',
          fontdict={'family': 'serif',
                    ...
                    'weight': 'bold',
                    'size': 8})
  plt.savefig(args.data_dir+'-'+str(args.max_epochs)+'ep-scale_mixup:'+str(args.scale_mixup)+'-alpha:'+str(args.alpha)+'-beta:'+str(args.beta)+'-tsne-XL.png', dpi=120)
...
if(args.tsne_graph == "True"):
  ...
  plt.title(args.data_dir+'-'+str(args.max_epochs)+'ep-scale_mixup:'+str(args.scale_mixup)+'-alpha:'+str(args.alpha)+'-beta:'+str(args.beta)+'_tsne-XU',
          fontdict={'family': 'serif',
                    ...
                    'weight': 'bold',
                    'size': 8})
  plt.savefig(args.data_dir+'-'+str(args.max_epochs)+'ep-scale_mixup:'+str(args.scale_mixup)+'-alpha:'+str(args.alpha)+'-beta:'+str(args.beta)+'-tsne-XU.png', dpi=120)
